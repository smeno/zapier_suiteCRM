...
//         id: '3b58fa24-bf02-1bf9-6658-659d2027c27c',
//         attributes: {
//           salutation_c: 'M',
//         },
//       },
...
//   display: {
//     description:
//       'Updates an existing record in any module you specify (Accounts, Contacts, Cases, etc..).',
//     hidden: false,
//     label: 'Update record',
//   },
//   key: 'update_record',
...
const perform = async (z, bundle) => {
  // Construisez le corps de la demande en fonction du module choisi
  const requestBody = {
    data: {
      type: bundle.inputData.modules,
      attributes: {},
  ...
  if (bundle.inputData.modules === 'Accounts') {
    requestBody.data.id = bundle.inputData.record;
  ...
  const options = {
    ...
    params: {},
    body: requestBody, // le corps de la demande dynamique
  };
...
module.exports = {
  display: {
    description:
      'Updates an existing record in any module you specify (Leads, Contacts, Tasks, etc..).',
    hidden: false,
    label: 'Update record',
  },
  key: 'Update_record',
  ...
  operation: {
    inputFields: [
      ...
      },
      {
        ...
        label: 'Record',
        type: 'string',
        dynamic: 'all_records.id.name',
        required: true,
        list: false,
        altersDynamicFields: false,
      },
      getDynamicFields, //pour recup les champs en fonctions du choix du module
